...
#include "bounding_box.h" // Ensure BoundingBox is included
...
public:
    ...
    const std::vector<BoundingBox>& GetBoundingBoxes() const; // Added
...
private:
    ...
    Tracker tracker_;
    cv::Rect roi_;
    std::vector<BoundingBox> bboxes_; // Added to store bounding boxes
