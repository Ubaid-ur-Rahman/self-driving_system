...
public:
    SemanticSegmentationEngine() : num_threads_(4) {}
...
private:
    ...
    std::vector<InferenceHelper::InputTensorInfo> input_tensor_info_list_;
    std::vector<InferenceHelper::OutputTensorInfo> output_tensor_info_list_;
};
